...
config :isthmus, IsthmusWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: IsthmusWeb.ErrorHTML, json: IsthmusWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Isthmus.PubSub,
  live_view: [signing_salt: "Z+brqS04"]
...
config :isthmus, Isthmus.Mailer, adapter: Swoosh.Adapters.Local
